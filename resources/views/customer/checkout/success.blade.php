...
<div class="container" style="max-width:760px">
    <div style="text-align:center;padding:48px 0 28px">
        <div style="width:74px;height:74px;border-radius:50%;background:#e7f6ec;display:grid;place-items:center;margin:0 auto 18px">
            <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="var(--ok)" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6 9 17l-5-5"/></svg>
        </div>
    ...
    <div class="form-card">
        ...
        <div style="margin-top:18px">
            <div class="line" style="display:flex;justify-content:space-between;padding:7px 0;color:var(--ink-soft);font-size:14.5px"><span>Tạm tính</span><span>{{ number_format($order->total_amount,0,',','.') }}₫</span></div>
            @if($order->discount_amount > 0)
            <div style="display:flex;justify-content:space-between;padding:7px 0;font-size:14.5px"><span>Giảm giá</span><span style="color:var(--accent)">−{{ number_format($order->discount_amount,0,',','.') }}₫</span></div>
            @endif
