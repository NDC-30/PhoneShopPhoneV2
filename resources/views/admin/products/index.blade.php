            ...
            <div class="table-responsive">
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        @forelse($products as $product)
                            <tr>
                                ...
                                <td>
                                    ...
                                    @if ($product->status == 1)
                                        <form action="{{ route('admin.products.unpublish', $product->product_id) }}"
                                            method="POST" class="d-inline">
                                            @csrf
                                            <button type="submit" class="btn btn-sm btn-secondary">
                                                <i class="bi bi-pause-circle"></i> Dừng bán
                                            </button>
                                        </form>
                                    @else
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="text-center text-muted py-4">Chưa có sản phẩm nào trong hệ thống!
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
